...
#ifndef CSC1061CAPSTONE_IRON_HATCHET_H
#define CSC1061CAPSTONE_IRON_HATCHET_H

#include "../item.h"

class iron_hatchet : public item{
public:
...
private:
    std::string _name = "Iron Hatchet";
    int _count = 0;
    itemType _type = itemType::IronHatchet;
    double _dropMultiplier = 3;
    int _dropCount = 1;
};

#endif //CSC1061CAPSTONE_IRON_HATCHET_H
